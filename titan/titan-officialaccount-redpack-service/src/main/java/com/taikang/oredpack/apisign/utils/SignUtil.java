package com.taikang.oredpack.apisign.utils;
...
public class SignUtil {
	...
	/** 加密密钥 */
	private final static String APP_KEY = "middle-tier-123456";
	...
	public static Map<String, String> sign(Map<String, String> sParaTemp) {
		...
		// 生成签名结果
		String mysign = DigestUtils.md5DigestAsHex(getContentBytes(prestr + APP_KEY, INPUT_CHARSET));
		// 签名结果加入请求提交参数组中
	...
	public static boolean verify(Map<String, String> params) {
		...
		// 获得签名验证结果
		String mysign = DigestUtils.md5DigestAsHex(getContentBytes(preSignStr + APP_KEY, INPUT_CHARSET));
		if (mysign.equals(sign)) {
			...
			logger.info("send sign======"+sign);
			logger.info("generator sign======"+mysign);
			logger.info("sign is different");
			return false;
		}
	}
}